...
struct MD5Sum< ::nox_msgs::Scene_<ContainerAllocator> >
{
  ...
  {
    return "bd297de99e4c75acc1fd884d71c28ceb";
  }

  static const char* value(const ::nox_msgs::Scene_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xbd297de99e4c75acULL;
  static const uint64_t static_value2 = 0xc1fd884d71c28cebULL;
};
