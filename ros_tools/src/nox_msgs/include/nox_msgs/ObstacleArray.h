...
struct MD5Sum< ::nox_msgs::ObstacleArray_<ContainerAllocator> >
{
  ...
  {
    return "3fa3bc595d6595953b731664cedd7e06";
  }

  static const char* value(const ::nox_msgs::ObstacleArray_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x3fa3bc595d659595ULL;
  static const uint64_t static_value2 = 0x3b731664cedd7e06ULL;
};
