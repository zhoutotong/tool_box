...
struct MD5Sum< ::nox_msgs::SignalArray_<ContainerAllocator> >
{
  ...
  {
    return "4ff849413d5a85492bf41c821950e570";
  }

  static const char* value(const ::nox_msgs::SignalArray_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x4ff849413d5a8549ULL;
  static const uint64_t static_value2 = 0x2bf41c821950e570ULL;
};
