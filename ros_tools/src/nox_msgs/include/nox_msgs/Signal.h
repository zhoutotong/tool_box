...
struct Signal_
{
  ...
  _description_type description;
   ...
   typedef std::vector< ::std_msgs::Byte_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::std_msgs::Byte_<ContainerAllocator> >::other >  _data_type;
  _data_type data;
...
struct MD5Sum< ::nox_msgs::Signal_<ContainerAllocator> >
{
  ...
  {
    return "4e9cff35f3d8881a6d37020aacb86c32";
  }

  static const char* value(const ::nox_msgs::Signal_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x4e9cff35f3d8881aULL;
  static const uint64_t static_value2 = 0x6d37020aacb86c32ULL;
};
...
struct Printer< ::nox_msgs::Signal_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::nox_msgs::Signal_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.data.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::std_msgs::Byte_<ContainerAllocator> >::stream(s, indent + "    ", v.data[i]);
    }
  }
};
